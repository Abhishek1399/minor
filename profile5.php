                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                           <div class="image-wrap">
                              <figure><img src="images/Pakoda.png" alt="Profile Image"></figure>
                           </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                           <div class="pull-left right-text white-txt">
                              <h6><a href="#">Pakode Wala</a></h6>
                              <a class="btn btn-small btn-green">Open</a>
                              <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                        ...
                        <div class="collapse in" id="1">
                              ...
                              <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-lg-8">
                                    <div class="rest-logo pull-left">
                                       <a class="restaurant-logo pull-left" href="#"><img src="images/paneer.png" alt="Food logo"></a>
                                    </div>
                                    <!-- end:Logo -->
                                    <div class="rest-descr">
                                       <h6><a href="#">Panner Pakoda</a></h6>
                                       <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                                    </div>
                                    <!-- end:Description -->
                                 </div>
                                 <!-- end:col -->
                                 <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left">₹ 80</span> <a href="#" class="btn btn-small btn btn-secondary pull-right" data-toggle="modal" data-target="#order-modal">&#43;</a> </div>
                              </div>
                              <!-- end:row -->
                           </div>
                           <!-- end:Food item -->
                           <div class="food-item">
                              <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-lg-8">
                                    <div class="rest-logo pull-left">
                                       <a class="restaurant-logo pull-left" href="#"><img src="images/aalo.png" alt="Food logo"></a>
                                    </div>
                                    <!-- end:Logo -->
                                    <div class="rest-descr">
                                       <h6><a href="#">Aalo Pakoda</a></h6>
                                       <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                                    </div>
                                    <!-- end:Description -->
                                 </div>
                                 <!-- end:col -->
                                 <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left">₹  45</span> <a href="#" class="btn btn-small btn btn-secondary pull-right" data-toggle="modal" data-target="#order-modal">&#43;</a> </div>
                              </div>
                              <!-- end:row -->
                           </div>
                           <!-- end:Food item -->
                           <div class="food-item white">
                              <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-lg-8">
                                    <div class="rest-logo pull-left">
                                       <a class="restaurant-logo pull-left" href="#"><img src="images/pyaaz.png" alt="Food logo"></a>
                                    </div>
                                    <!-- end:Logo -->
                                    <div class="rest-descr">
                                       <h6><a href="#">Pyaaz Pakoda</a></h6>
                                       <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                                    </div>
                                    <!-- end:Description -->
                                 </div>
                           ...
                           <div class="food-item">
                              <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-lg-8">
                                    <div class="rest-logo pull-left">
                                       <a class="restaurant-logo pull-left" href="#"><img src="images/mirchi.png" alt="Food logo"></a>
                                    </div>
                                    <!-- end:Logo -->
                                    <div class="rest-descr">
                                       <h6><a href="#">Mirchi Pakoda</a></h6>
                                       <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                                    </div>
                                    <!-- end:Description -->
                                 </div>
                     ...
                     <div class="menu-widget" id="2">
                           ...
                           <div class="food-item">
                              <div class="row">
                                 <div class="col-xs-12 col-sm-12 col-lg-8">
                                    <div class="rest-logo pull-left">
                                       <a class="restaurant-logo pull-left" href="#"><img src="images/gobhi.png" alt="Food logo"></a>
                                    </div>
                                    <!-- end:Logo -->
                                    <div class="rest-descr">
                                       <h6><a href="#">Gobhi Pakoda</a></h6>
                                       <p>Panner Pakoda, Aalo Pakoda, Pyaaz Pakoda, Mirchi Pakoda, Gobhi Pakoda</p>
                                    </div>
                                    <!-- end:Description -->
                                 </div>
                        ...
                        <div class="col-sm-12 col-xs-12">
                           <div class="panel">
                              <div class="panel-heading">
                                 <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false">Related To Pakode Wala, Nauroji Nagar</a></h4>
                              </div>
                              <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                                 <div class="panel-body">Located on the Rajmata Vijaye Raje Scindia Marg, Khandaani Pakode Wala is situated between the Bhikaji Cama flyover and the Sarojini Nagar crossing on the Ring Road. The area is also known as Nauroji Nagar and the iconic street food joint is also popularly known as Nauroji Nagar Pakode wale.</div>
                              </div>
                           </div>
                           <!--//panel-->
                           <div class="panel">
                              <div class="panel-heading">
                                 <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2"><i class="ti-info-alt"></i>What is the best of Pakode Wala's ?</a></h4>
                              </div>
                              <div class="panel-collapse collapse" id="faq2">
                                 <div class="panel-body">They are famous of their Pakoda Making style and has varities of different pakoda. But <strong>Pyaaz Pakoda & Paneer Pakoda</strong> are Just best.</div>
                              </div>
                           </div>
                           <!--//panel-->
                           <div class="panel">
                              <div class="panel-heading">
                                 <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq3"><i class="ti-info-alt"></i>Do Pakode Wala's Prepare Fresh meals?</a></h4>
                              </div>
